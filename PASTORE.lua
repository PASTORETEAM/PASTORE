...
if hash or DevPASTORE(msg) then  
return true  
else  
return false  
end  
...
local hash = database:sismember(bot_id.."PASTORE:Basic:Constructor23"..msg.chat_id_, msg.sender_user_id_) 
if hash or DevPASTORE(msg) or DevBot(msg) then    
return true    
else    
return false    
end 
...
if hash or DevPASTORE(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
if hash or DevPASTORE(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevPASTORE(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevPASTORE(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevPASTORE(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
elseif database:sismember(bot_id.."PASTORE:Basic:Constructor23"..chat_id, user_id) then
var = "المالك"
elseif database:sismember(bot_id.."PASTORE:Basic:Constructor"..chat_id, user_id) then
...
for PASTORE in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = PASTORE
end
...
function PASTORE_Started_Bot(msg,data) 
if msg then
...
local PASTORE_Msg = database:get(bot_id.."PASTORE:Add:Filter:Rp2"..text..msg.chat_id_)   
if PASTORE_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","◈︙"..PASTORE_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
if text == ("مسح قائمة العام") and DevPASTORE(msg) then
...
if text == ("قائمة العام") and DevPASTORE(msg) then
...
if text == ("رفع مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevPASTORE(msg) then
function Function_PASTORE(extra, result, success)
...
if text and text:match("^رفع مطور @(.*)$") and DevPASTORE(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevPASTORE(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id.."PASTORE:Sudo:User", userid)
Reply_Status(msg,userid,"reply","◈︙ تم رفعه مطور .")  
return false 
end
if text == ("تنزيل مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevPASTORE(msg) then
function Function_PASTORE(extra, result, success)
...
if text and text:match("^تنزيل مطور @(.*)$") and DevPASTORE(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevPASTORE(msg) then
...
function Function_PASTORE(extra, result, success)
if result.id_ then
database:srem(bot_id.."PASTORE:Basic:Constructor23"..msg.chat_id_, result.id_)
...
if database:get(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n◈︙ ارسل الكلمة الان .')
database:set(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:PASTORE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:PASTORE:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:PASTORE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الرد .")
database:del(bot_id..'botss:PASTORE:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:PASTORE:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:PASTORE:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:PASTORE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:PASTORE:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعددة") and DevPASTORE(msg) then
 
local list = database:smembers(bot_id.."botss:PASTORE:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:PASTORE:List:Rd:Sudo")
end
send(msg.chat_id_, msg.id_,"◈︙ تم حذف الردود المتعددة .")
end
if text == ("الردود المتعددة") and DevPASTORE(msg) then
...
if text == "اضف رد متعدد" and DevPASTORE(msg) then
 
database:set(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◈︙ ارسل الرد الان .")
end
if text == "حذف رد متعدد" and DevPASTORE(msg) then
 
database:set(bot_id.."botss:PASTORE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◈︙ ارسل الرد المراد حذفه . ")
end
if text then  
local test = database:get(bot_id.."botss:PASTORE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:PASTORE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:PASTORE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:PASTORE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:PASTORE:Add:Rd:Sudo:Text2"..text)   
...
database:sadd(bot_id.."PASTORE:Basic:Constructor23"..msg.chat_id_, result.id_)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_PASTORE, nil)
return false
end
------------------------------------------------------------------------
...
local list = database:smembers(bot_id.."PASTORE:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."PASTORE:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."PASTORE:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."PASTORE:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n◈︙ قائمة المنع .\n- - - - -\n"
for k,v in pairs(list) do  
local PASTORE_Msg = database:get(bot_id.."PASTORE:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..PASTORE_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."PASTORE:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."PASTORE:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."PASTORE:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."PASTORE:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."PASTORE:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."PASTORE:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."PASTORE:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."PASTORE:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."PASTORE:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."PASTORE:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
if database:sismember(bot_id.."PASTORE:Sudo:User",result.id_) then
dev = "مطور " else dev = "" end
if database:sismember(bot_id.."PASTORE:Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي " else crr = "" end
if database:sismember(bot_id.."PASTORE:Constructor"..msg.chat_id_, result.id_) then
cr = "منشئ " else cr = "" end
if database:sismember(bot_id.."PASTORE:Manager"..msg.chat_id_, result.id_) then
own = "مدير " else own = "" end
if database:sismember(bot_id.."PASTORE:Mod:User"..msg.chat_id_, result.id_) then
mod = "مدير " else mod = "" end
if database:sismember(bot_id.."PASTORE:Special:User"..msg.chat_id_, result.id_) then
...
if database:sismember(bot_id.."PASTORE:Sudo:User",result.sender_user_id_) then
dev = "مطور " else dev = "" end
if database:sismember(bot_id.."PASTORE:Basic:Constructor"..msg.chat_id_, result.sender_user_id_) then
crr = "منشئ اساسي " else crr = "" end
if database:sismember(bot_id.."PASTORE:Constructor"..msg.chat_id_, result.sender_user_id_) then
cr = "منشئ " else cr = "" end
if database:sismember(bot_id.."PASTORE:Manager"..msg.chat_id_, result.sender_user_id_) then
own = "مدير " else own = "" end
if database:sismember(bot_id.."PASTORE:Mod:User"..msg.chat_id_, result.sender_user_id_) then
mod = "ادمن " else mod = "" end
if database:sismember(bot_id.."PASTORE:Special:User"..msg.chat_id_, result.sender_user_id_) then
vip = "مميز " else vip = ""
end
...
database:sadd(bot_id.."PASTORE:Basic:Constructor"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
end
...
if text == "تفعيل المغادرة" and DevPASTORE(msg) then   
database:del(bot_id.."PASTORE:Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"◈︙ تم تفعيل المغادرة .") 
return false 
end
if text == "تعطيل المغادرة" and DevPASTORE(msg) then  
database:set(bot_id.."PASTORE:Left:Bot"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "◈︙ تم تعطيل المغادرة .") 
return false 
end
if text == (database:get(bot_id.."PASTORE:Name:Bot") or "الكس") then
Namebot = (database:get(bot_id.."PASTORE:Name:Bot") or "الكس")
local namebot = {
"يا حبيب "..Namebot.. " كول",
"ها عمري اني "..Namebot,
'ها يروحا كول ؟',
...
if text == "تفعيل الاذاعة" and DevPASTORE(msg) then  
database:del(bot_id.."PASTORE:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n◈︙ تم تفعيل الاذاعة ." ) 
return false
end 
if text == "تعطيل الاذاعة" and DevPASTORE(msg) then  
...
local NumMsg = database:get(bot_id..'PASTORE:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = database:get(bot_id.."PASTORE:Comd:New:rt:User:"..msg.chat_id_..Id) or Get_Rank(Id,msg.chat_id_)
local message_edit = database:get(bot_id..'PASTORE:message_edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
download_to_file('https://raw.githubusercontent.com/PASTORETEAM/PASTORE/main/PASTORE.lua', 'PASTORE.lua') 
download_to_file('https://raw.githubusercontent.com/PASTORETEAM/PASTORE/main/start.lua', 'start.lua') 
dofile('PASTORE.lua')  
return false
end
...
if text and text:match("^تعيين عدد الاعضاء (%d+)$") and DevPASTORE(msg) then
...
if text == 'جلب نسخة احتياطية' and DevPASTORE(msg) then
local list = database:smembers(bot_id..'PASTORE:Chek:Groups')  
...
if DevPASTORE(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourcePASTORE/SourcePASTORE/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SourcePASTORE/SourcePASTORE/master/"..file)
if res == 200 then
...
if text == 'وضع كليشة المطور' and DevPASTORE(msg) then
database:set(bot_id..'PASTORE:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'◈︙ ارسل الكليشة الان .')
return false
end
if text and database:get(bot_id..'PASTORE:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'PASTORE:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
...
if text == 'رفع نسخة احتياطية' and DevPASTORE(msg) then   
...
{
{text = '- Source PASTORE .', url = "https://t.me/JJJJJ9"}
},
{
...
send(msg.chat_id_, msg.id_,'◈︙ لا يمكنك تفعيل البوت لان عدد الاهضاء اقل من : {'..(database:get(bot_id..'PASTORE:Num:Add:Bot') or 0)..' .')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
database:sadd(bot_id..'PASTORE:Basic:Constructor23'..msg.chat_id_, owner_id)
end
end
end,nil)
...
database:set(bot_id.."PASTORE:Private:Group:Link"..msg.chat_id_,LinkGp) 
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'PASTORE:Num:Add:Bot') or 0) and not DevPASTORE(msg) then
send(msg.chat_id_, msg.id_,'◈︙ لا يمكنك تفعيل البوت لان عدد الاعضاء اقل من : {'..(database:get(bot_id..'PASTORE:Num:Add:Bot') or 0)..' .')
return false
end
...
if not DevPASTORE(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
{text = '- Source PASTORE .', url = "https://t.me/JJJJJ9"}
    ...
    database:del(bot_id.."PASTORE:Link_Group"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."PASTORE:Chek:Welcome"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."PASTORE:Reply:Sudo"..Chat_id,true)   
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id..'PASTORE:Lock:ID:Bot'..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id..'PASTORE:Lock:ID:Bot:Photo'..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."PASTORE:Kick:Me"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."PASTORE:Reply:Manager"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."PASTORE:Link_Group"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:set(bot_id.."PASTORE:Chek:Welcome"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."PASTORE:Reply:Sudo"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id..'PASTORE:Lock:ID:Bot'..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id..'PASTORE:Lock:ID:Bot:Photo'..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."PASTORE:Kick:Me"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
    ...
    database:del(bot_id.."PASTORE:Reply:Manager"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homeaddrem"},
...
{text = '- Source PASTORE .', url = "https://t.me/JJJJJ9"}
    ...
    database:set(bot_id.."PASTORE:Lock:AddMempar"..Chat_id,"kick")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    ...
    database:set(bot_id.."PASTORE:Lock:text"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Join"..Chat_id,"kick")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Bot:kick"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:tagservr"..Chat_id,true)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:edit"..Chat_id,true) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Link"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:User:Name"..Chat_id,"del") 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:hashtak"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Sticker"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Animation"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Video"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Photo"..Chat_id,"del")    
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Audio"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:vico"..Chat_id,"del")    
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:forward"..Chat_id,'del')  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Document"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Contact"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Spam"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:hset(bot_id.."PASTORE:flooding:settings:"..Chat_id ,"flood","del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:set(bot_id.."PASTORE:Lock:Inlen"..Chat_id,"del")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:AddMempar"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:text"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Join"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Bot:kick"..Chat_id)   
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:tagservr"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:edit"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Link"..Chat_id) 
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:User:Name"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:hashtak"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Sticker"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Animation"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Video"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Photo"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Audio"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:vico"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:forward"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Document"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Contact"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Spam"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:hdel(bot_id.."PASTORE:flooding:settings:"..Chat_id ,"flood")  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
    ...
    database:del(bot_id.."PASTORE:Lock:Inlen"..Chat_id)  
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    {text = 'القائمة الرئيسية', callback_data=data.sender_user_id_.."/homelocks"},
...
{text = '- Source PASTORE .', url = "https://t.me/JJJJJ9"}
    ...
    database:del(bot_id..'PASTORE:nwe:mem:group'..msg.chat_id_) 
    send(msg.chat_id_, msg.id_,'\n- تم تعطيل التحقق' ) 
    end
    if text == 'تفعيل التحقق' and Addictive(msg) then  
    database:set(bot_id..'PASTORE:nwe:mem:group'..msg.chat_id_,'true') 
    send(msg.chat_id_, msg.id_,'\n- تم تفعيل التحقق' ) 
    end 
    
    if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'PASTORE:nwe:mem:group'..msg.chat_id_) == 'true'then
    numphoto = {'3','8','9','6'}
...
local Name_Bot = (database:get(bot_id.."PASTORE:Name:Bot") or "تشاكيx")
...
------------------------------------------------------------------------
if text then
local PASTORE_Msg = database:get(bot_id.."PASTORE:Add:Filter:Rp2"..text..result.chat_id_)   
if PASTORE_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..PASTORE_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
